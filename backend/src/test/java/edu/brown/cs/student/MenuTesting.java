...
public class MenuTesting {
  ...
  private String mondayUrl = "/Users/channingbryant/Desktop/cs320/term-project-ssoufan-cpbryant-dsedarou-aye15/backend/src/main/java/MondayMenu.csv";

  private String fridayUrl = "/Users/channingbryant/Desktop/cs320/term-project-ssoufan-cpbryant-dsedarou-aye15/backend/src/main/java/FridayMenu.csv";
  ...
  @BeforeEach
  public void setup() {
    Spark.get("menu", new MenuHandler(mondayUrl));
    Spark.init();
...
//    assertEquals("The search query must be formatted as 'mapsKeyWord?Area=[area description]'", body.get("error_description"));
  ...
  @Test
  public void testSaturdayMenuNoRestriction() throws IOException{
    HttpURLConnection loadConnection = tryRequest("menu?restriction=");
    Map<String, Object> body =
        adapter.fromJson(new Buffer().readFrom(loadConnection.getInputStream()));
    assertEquals(200, loadConnection.getResponseCode());
